...
│   │   ├── models/             # TypeScript data models per connector
│   │   └── services/           # Typed service classes per connector
│   ├── components/             # Reusable React components
│   ├── hooks/                  # Custom React hooks
│   └── App.tsx                 # App entry point
├── docs/
│   ├── data-connections.md     # Connector setup guide
...
├── templates/
│   └── connection-reference-template.json  # Solution connection ref template
